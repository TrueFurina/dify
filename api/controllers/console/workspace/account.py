...
class EducationApi(Resource):
    ...
    def post(self, request_context: RequestContext):
        try:
            application_services().accounts.education.activate(request_context)
        except account_errors.EducationDiscountPausedError:
            raise EducationDiscountTemporarilyPausedError() from None
